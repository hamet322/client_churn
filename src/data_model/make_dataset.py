...
def main():
    df2 = pd.read_csv(os.path.join('data/rocessed/clean.csv'))
    ...
    #Para la prediccion elimanos las columnas que no tendremos
    df_test.drop(columns=["churn","id"], axis = 1, inplace = True)
